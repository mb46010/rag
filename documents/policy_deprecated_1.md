Deprecated # Global Expense & Travel Policy

## 1. Principle
The company reimburses employees for necessary and reasonable business expenses incurred in the performance of their duties. Employees are expected to exercise good judgment and act as responsible stewards of company funds, spending as they would their own money.

## 2. Air Travel
- **Booking**: All air travel must be booked through the corporate travel portal (Egencia/Concur) at least 14 days in advance whenever possible to secure the best rates.
- **Class of Service**:
    - **Economy Class**: The standard for all domestic flights and international flights with a duration of less than 6 hours.
    - **Premium Economy**: Permitted for flights between 6 and 10 hours.
    - **Business Class**: Permitted for international flights with a duration exceeding 10 hours (excluding layovers).
    - **First Class**: Not reimbursable under any circumstances.
- **Ancillary Fees**: Reasonable baggage fees (1 checked bag) are reimbursable. Wi-Fi on flights is reimbursable if work is required.

## 3. Ground Transportation
- **Ride Sharing/Taxis**: Uber/Lyft or standard taxis are preferred for airport transfers and local travel. Luxury services (Uber Black, etc.) are only permitted if no other option is available or for client transport.
- **Car Rentals**: Permitted for trips where ride-sharing is cost-prohibitive or impractical. Compact or Intermediate class cars should be booked. Insurance should be declined as the corporate policy covers rentals.
- **Personal Car Usage**: Mileage is reimbursed at the current IRS (or local tax authority) standard rate. Gas is not reimbursed separately for personal cars; it is covered by the mileage rate.
